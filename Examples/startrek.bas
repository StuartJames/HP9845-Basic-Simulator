...
170  GOSUB 5460
180  PRINT "                          STAR TREK "
190  INPUT "DO YOU WANT INSTRUCTIONS (THEY'RE LONG!)", A$
210  IF UPC$(A$[1]) <> "Y" THEN 230
220  GOSUB 5820
230  REM *****  PROGRAM STARTS HERE *****
240  GOSUB 5460
250  DIM G(8,8),C(9,2),K(3,3),N(3),Z(8,8),D(10)
260  DIM C$[6],D$[72],E$[24],A$[3],Q$[72],R$[72],S$[48]
270  DIM Z$[72]
280  Z$="                                                                      "
290  T=INT(RND*20+20)*100
291  T0=T
300  T9=30
310  D0=0
320  E=3000
...
4670  INPUT A
4680  ON A+1 GOTO 4740,4830,4880
